...
const PDP = () => {
    ...
    const { id, type, title, description, price, saleprice, category, image_folder, image, gallery, highlights, includes, tags } = state;
    ...
    return (
        <div class="pb-20 px-20 flex justify-center">
            <div class="pt-6 max-w-[1440px]">
                <div className='bg-blue-800 text-white p-4 rounded-lg mb-6'>
                    <nav aria-label="Breadcrumb">
                        <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                            ...
                            <li>
                                <div class="flex items-center">
                                    <Link to="/" class="mr-2 text-sm font-medium text-gray-300 hover:text-blue-400">{category[0]}</Link>
                ...
                <div class="bg-slate-700 rounded-xl mx-auto max-w-2xl px-4 py-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto_auto_1fr] lg:gap-x-8 lg:px-8 lg:py-16">
                    ...
                    <div class="mt-4 lg:row-span-3 lg:mt-0">
                        ...
                        <div class="mt-6 flex items-center">
                            <span class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-gray-800/30 text-blue-500">
                    ...
                    <div class="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pt-6 lg:pr-8 lg:pb-16">
                        ...
                        <div class="flex flex-row mt-10">
                            <div className='flex-1'>
                                <h3 class="text-md font-medium text-blue-400">Highlights</h3>
                            ...
                            <div className='flex-1'>
                                <h3 class="text-md font-medium text-blue-400">Includes</h3>
                        ...
                        {/* <div class="mt-10">
                            <h2 class="text-md font-medium text-blue-500">Details</h2>
